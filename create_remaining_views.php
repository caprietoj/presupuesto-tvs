...
$sections = [
    ...
    'gastos-contratacion' => 'Gastos de Contratación',
    'afiliaciones-suscripciones' => 'Afiliaciones y Suscripciones',
    'ib' => 'IB',
    'entrenamientos' => 'Entrenamientos',
    'servicios-publicos' => 'Servicios Públicos',
    'reparaciones-mayores' => 'Reparaciones Mayores',
    'reparacion-muebles' => 'Reparación Muebles',
    'mercadeo' => 'Mercadeo'
];
...
foreach ($sections as $filename => $title) {
    $content = str_replace(['TITLE', 'SECTION_TITLE'], [$title, strtoupper($title)], $template);
    $filepath = "resources/views/secciones/{$filename}.blade.php";
